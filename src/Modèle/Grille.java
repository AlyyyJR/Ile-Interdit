...
/**
 * Représente le plateau de jeu : une grille 6×6 contenant des {@link Tuile}s.
 *
 * <p>Seules 24 positions sur les 36 sont jouables ; les autres restent à {@code null}.
 * En mode normal, les zones et les positions de départ inondées sont mélangées aléatoirement.
 * En mode debug, une configuration fixe prédéfinie est utilisée pour les tests.</p>
 *
...
public class Grille {
    ...
    // Attributs
    // ==================================================================
    /** Tableau bidimensionnel des tuiles (6 lignes × 6 colonnes). Les cases hors plateau sont {@code null}. */
     ...
     *
     * @param modeDebug si {@code true}, initialise une grille fixe de test ;
     ...
     *
     * <p>Les 24 zones du jeu sont assignées aléatoirement aux 24 positions jouables.
     * Parmi ces positions, 6 sont tirées au sort et reçoivent l'état {@code Inondé} dès le départ.</p>
     */
     ...
     *
     * <p>Les zones, états et couleurs de reliques sont définis statiquement
     * afin de garantir un scénario de test reproductible.</p>
     */
     ...
     *
     * @return tableau 6×6 de tuiles (certaines cellules peuvent être {@code null})
     */
     ...
     * @return la tuile à cette position, ou {@code null} si hors plateau
     */
     ...
     * @return la tuile correspondante, ou {@code null} si hors plateau
     */
     ...
     * @return la tuile correspondante, ou {@code null} si non trouvée
     */
